...
python src/download.py https://archive.ics.uci.edu/ml/machine-learning-databases/cmc/cmc.data data/raw/contraceptive_data.csv
...
def main(url, output_file1):
  ...
  try:
      column_name = ['Wife_age','wide_education','husband_Education','children_born','wife_Religion','wife_Working_now',
                    'husband_occupation','standard_of_living','media_Exposure','contraceptive_method_use']
      data.to_csv(output_file1, index = False, header = column_name)
  except:
